...
function return_status_banner() {
    return '<div id="info_banner" class="info">Successfully updated configuration for add-on "TA-neo4j". </div>' +
    '<div id="save_err_banner" class="error">Fail to update configuration for add-on "TA-neo4j". </div>' +
    '<div id="load_err_banner" class="error">Fail to load configuration for add-on "TA-neo4j". </div>';
}
                ...
                '<div class="fieldsetWrapper" id="credSettingId">' +
                    '<fieldset>' +
                        ...
                        '<div>' +
                            ...
                            '<a class="float-right color-gray mgr-16 credBtn btn" id="passwordBtnAdd">Add Account</a>' +
                        '</div>' +
                        '<br>' +
                        '<br>' +
                        '<div>' +
...
// begin to process the doc
    ...
    function appConfigured() {
        $.ajax({
            url: "/en-US/splunkd/__raw/services/apps/local/TA-neo4j",
            type: "POST",
            data: {
                "configured": true
            }
    ...
    function saveSettings() {
        ...
        $.ajax({
            url:"/en-US/splunkd/__raw/servicesNS/-/TA-neo4j/TA-neo4j_input_setup/TA-neo4j_settings/TA-neo4j_settings",
            type: "POST",
            data: {
